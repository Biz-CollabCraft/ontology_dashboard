...
- 원본 커밋 제목: `fix: limit MVP demo login roles`

## 목적

개인 프로토타입에만 존재하던 Week 2 MVP 실행 코드를 팀 저장소의 실제 개발
기준으로 승격한다. 문서만 복사하는 것이 아니라 MVP 화면을 실행하는 프론트엔드와
...
`docs/mentoring-mvp-2026-08/`에 존재하므로 중복 계약 문서를 만들지 않는다.
