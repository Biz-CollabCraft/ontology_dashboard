...
- [MVP / Product documentation](./mvp/README.md)
  ...
  - [공통 스키마 정의](./mvp/schema-definition.md)
  - [Generator Feature/Label 계약](./mvp/generator-feature-label-contract.md)
  - [Model Artifact Publish 계약](./mvp/model-artifact-publish-contract.md)
