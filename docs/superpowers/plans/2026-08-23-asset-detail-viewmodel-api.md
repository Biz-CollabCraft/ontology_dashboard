...
**Goal:** Build the first PR95 follow-up slice for `AssetDetailViewModel` as a backend-owned composition contract, without promoting prototype or gen_data fixture internals to runtime truth.
...
**Files:**
- Create: `contracts/schemas/asset-detail-view-model.schema.json`
- Create: `tests/fixtures/asset_detail_view_model/current-evidence-only.json`
- Create: `tests/test_asset_detail_view_model_contract.py`
...
Run: `pytest -q tests/test_asset_detail_view_model_contract.py`
...
Define `AssetDetailRequest`, `AssetDetailReadPort`, `AssetDetailViewModelService`, and `compose_asset_detail_view_model()`. The service reads only from the port; the composer never opens files or imports generator/prototype modules.

- [ ] **Step 3: Verify**

Run: `pytest -q tests/test_asset_detail_view_model_contract.py tests/test_asset_detail_view_model_composer.py`
...
Run: `pytest -q tests/test_asset_detail_view_model_contract.py tests/test_asset_detail_view_model_composer.py tests/test_report_domain_migration.py`
