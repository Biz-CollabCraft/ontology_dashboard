...
| Internal Generator Prediction Stage Schema | **Internal** | `contracts/schemas/generator-prediction-result-batch.schema.json` (Generator 내부 staging 및 checkpoint 전용 계약) |
