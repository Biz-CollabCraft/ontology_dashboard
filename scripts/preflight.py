...
REQUIRED_FILES = [
    ...
    "systems/backend/ontology_dashboard/settings.py",
    ...
    "systems/backend/ontology_dashboard/identity_models.py",
    "systems/backend/ontology_dashboard/identity_repository.py",
    ...
    "systems/backend/ontology_dashboard/adapters/bundle_models.py",
    "systems/backend/ontology_dashboard/adapters/bundle_file_adapter.py",
    "systems/backend/ontology_dashboard/adapters/predictive_maintenance_v2.py",
    "systems/backend/ontology_dashboard/adapters/postgresql_bundle_ingestion.py",
    ...
    "systems/backend/ontology_dashboard/predictive_maintenance_runtime/repository.py",
