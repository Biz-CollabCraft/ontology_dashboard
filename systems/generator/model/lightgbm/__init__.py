"""LightGBM model implementation for predictive maintenance."""
...
class LightGBMModel:
    """LightGBM-based failure probability prediction model."""
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        """Train the LightGBM classifier with explicit feature allowlist."""
