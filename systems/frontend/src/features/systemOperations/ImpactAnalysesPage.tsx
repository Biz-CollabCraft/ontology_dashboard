...
export function ImpactAnalysesPage() {
  ...
  return <main className="ops-page"><button className="ops-back" onClick={() => navigate("/system/operations/assets")}>← 운영 자산</button><header><p className="ops-eyebrow">SYSTEM OPERATIONS</p><h1>Downstream 영향 분석</h1><p>Mapping 또는 관리 계약 변경이 후속 학습 파이프라인에 미치는 영향을 snapshot으로 고정합니다.</p></header>
