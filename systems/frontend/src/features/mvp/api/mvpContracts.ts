export type MvpDecisionBriefRole =
  | "process_manager"
  | "process_engineer"
  | "maintenance_technician"
  | "system_admin";

export interface MvpDecisionSupportBrief {
  schema_version: string;
  frame: {
    evidence_snapshot_id: string;
    decision_as_of: string;
    actor_role: MvpDecisionBriefRole;
    risk_status: string;
    asset_id: string;
...
export interface MvpDecisionSupportResponse {
  brief: MvpDecisionSupportBrief | null;
  trace: {
    status: string;
    reason: string | null;
    reused: boolean;
