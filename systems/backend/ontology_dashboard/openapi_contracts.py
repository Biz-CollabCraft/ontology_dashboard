...
_EXPLICIT_MODELS: dict[str, Any] = {
    ...
    "app.maintenance.maintenance_router.record_decision": ActionMutationResponse,
    "app.maintenance.maintenance_router.add_note": ActionMutationResponse,
    "app.maintenance.maintenance_router.event_activity": EventActivityResponse,
