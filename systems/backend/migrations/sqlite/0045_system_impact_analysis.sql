CREATE TABLE IF NOT EXISTS system_impact_analyses (
    ...
    include_stages_json TEXT NOT NULL, source_json TEXT NOT NULL, nodes_json TEXT NOT NULL,
    edges_json TEXT NOT NULL, actions_json TEXT NOT NULL, snapshot_sha256 TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS system_pipeline_job_steps (
    ...
    input_json TEXT NOT NULL, output_json TEXT, error_code TEXT, error_message TEXT,
    started_at TEXT, completed_at TEXT, UNIQUE(job_id,action_id)
);
