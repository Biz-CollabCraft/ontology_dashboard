CREATE TABLE IF NOT EXISTS system_audit_events (
  audit_id TEXT PRIMARY KEY, occurred_at TIMESTAMPTZ NOT NULL, actor_id TEXT NOT NULL,
  ...
  reason TEXT, error_code TEXT, before_ref_json JSONB, after_ref_json JSONB,
...
CREATE TABLE IF NOT EXISTS system_operational_logs (
  log_id TEXT PRIMARY KEY, occurred_at TIMESTAMPTZ NOT NULL, service TEXT NOT NULL,
  ...
  asset_id TEXT, model_id TEXT, metadata_json JSONB NOT NULL DEFAULT '{}'::jsonb
);
...
CREATE TABLE IF NOT EXISTS system_log_exports (
  ...
  format TEXT NOT NULL, filters_json JSONB NOT NULL, record_count INTEGER NOT NULL DEFAULT 0,
  truncated BOOLEAN NOT NULL DEFAULT FALSE, logical_uri TEXT, sha256 TEXT,
  error_code TEXT, created_at TIMESTAMPTZ NOT NULL, completed_at TIMESTAMPTZ
);
