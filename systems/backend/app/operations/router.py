...
def create_decision_session(
    ...
    try:
        result = session_service.create(identity=identity, actor_role=role.value, request_id=request_id, actor_id=principal.user_id)
    except (ValueError, DecisionRunBusy, DecisionRunLeaseLost) as exc:
