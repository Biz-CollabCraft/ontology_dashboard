...
from app.mvp.operational_evidence_selection import (
    EvidenceSelectionStrategy,
    evaluate_evidence_selection,
    project_evidence_candidates,
    select_evidence_candidates,
)
from app.mvp.operational_relation_resolver import resolve_operational_relations
...
class ManufacturingPredictiveMaintenanceService:
    ...
    def agent_review_evidence_selection(
        ...
        *,
        ...
        context_lookup_at = retrieved_at or now
        contexts = self._operational_selection_contexts(
            identity=identity,
            retrieved_at=context_lookup_at,
        )
        relations = resolve_operational_relations(
            identity=identity,
            contexts=contexts,
        )
